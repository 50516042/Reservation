...
public class NewUserDialog extends Dialog implements ActionListener,WindowListener{
	...
	TextField tfName;		//ユーザネームを入力するテキストフィールド
	...
	public NewUserDialog(Frame owner) {
		...
		//基底クラス(Dialog)のコンストラクタを呼び出す
				...
				panelNorth.add( new Label("ユーザネーム"));
